export const wordsEN = [
  ...
  {category: 'animal', name: 'kangaroo'},
  {category: 'animal', name: 'mosquito'},
  {category: 'animal', name: 'penguins'},
  {category: 'animal', name: 'reindeer'},
  {category: 'animal', name: 'scorpion'},
  {category: 'animal', name: 'seahorse'},
  {category: 'animal', name: 'squirrel'},
  {category: 'animal', name: 'starfish'},
  {category: 'animal', name: 'tortoise'},
  {category: 'animal', name: 'buffalo'},
  {category: 'animal', name: 'catfish'},
  {category: 'animal', name: 'chicken'},
  {category: 'animal', name: 'dolphin'},
  {category: 'animal', name: 'feather'},
  {category: 'animal', name: 'firefly'},
  {category: 'animal', name: 'firefox'},
  {category: 'animal', name: 'giraffe'},
  {category: 'animal', name: 'gorilla'},
  {category: 'animal', name: 'hamster'},
  {category: 'animal', name: 'ladybug'},
  {category: 'animal', name: 'lamprey'},
  {category: 'animal', name: 'leopard'},
  {category: 'animal', name: 'lobster'},
  {category: 'animal', name: 'mammoth'},
  {category: 'animal', name: 'narwhal'},
  ...
  {category: 'animal', name: 'raccoon'},
  {category: 'animal', name: 'reptile'},
  {category: 'animal', name: 'rooster'},
  {category: 'animal', name: 'seagull'},
  {category: 'animal', name: 'tadpole'},
  {category: 'animal', name: 'banana'},
  {category: 'animal', name: 'donkey'},
  ...
  {category:'building', name:'library'},
  {category:'building', name:'lighthouse'},
  ...
  {category:'building', name:'opera house'},
  {category:'building', name:'palace'},
  {category:'building', name:'petshop'},
  {category:'building', name:'police station'},
  {category:'building', name:'post office'},
  {category:'building', name:'prison'},
  {category:'building', name:'restaurant'},
  {category:'building', name:'saw mill'},
  {category:'building', name:'school'},
  {category:'building', name:'supermarket'},
  {category:'building', name:'temple'},
  ...
  {category:'pop culture', name:'chracter '},
  ...
  {category: 'event', name: 'election'},
  {category: 'festivity', name: 'festivus'},
  {category: 'festivity', name: 'hanukkah'},
  {category: 'event', name: 'yardsale'},
  {category: 'event', name: 'funeral'},
  {category: 'family', name: 'grandma'},
  {category: 'family', name: 'grandpa'},
  {category: 'family', name: 'husband'},
  {category: 'festivity', name: 'kwanzaa'},
  {category: 'family', name: 'parents'},
  {category: 'festivity', name: 'wedding'},
  {category: 'valuables', name: 'bracelet'},
  {category: 'valuables', name: 'crystal'},
  {category: 'valuables', name: 'diamond'},
  {category: 'valuables', name: 'emerald'},
  {category: 'valuables', name: 'jewelry'},
  {category: 'social', name: 'bromance'},
  {category: 'games', name: 'checkers'},
  {category: 'social', name: 'follower'},
  {category: 'social', name: 'highfive'},
  {category: 'toy', name: 'hulahoop'},
  {category: 'games', name: 'joystick'},
  {category: 'beverage', name: 'lemonade'},
  {category: 'social', name: 'marriage'},
  {category: 'games', name: 'monopoly'},
  {category: 'toy', name: 'pinwheel'},
  {category: 'games', name: 'scrabble'},
  {category: 'beverage', name: 'smoothie'},
  {category: 'toy', name: 'swingset'},
  {category: 'toy', name: 'balloon'},
  {category: 'social', name: 'divorce'},
  {category: 'toy', name: 'dreidel'},
  {category: 'social', name: 'frenemy'},
  {category: 'toy', name: 'gameboy'},
  {category: 'beverage', name: 'martini'},
  {category: 'games', name: 'pinball'},
  {category: 'beverage', name: 'sixpack'},
  {category: 'beverage', name: 'tequila'},
  {category: 'beverage', name: 'whiskey'},
  {category: 'games', name: 'yahtzee'},
  {category: 'furniture', name: 'barstool'},
  {category: 'furniture', name: 'bookcase'},
  {category: 'tool', name: 'chainsaw'},
  {category: 'tool', name: 'scissors'},
  {category: 'tool', name: 'tweezers'},
  {category: 'furniture', name: 'waterbed'},
  {category: 'furniture', name: 'bathtub'},
  {category: 'furniture', name: 'bunkbed'},
  {category: 'furniture', name: 'cabinet'},
  {category: 'tool', name: 'compass'},
  {category: 'tool', name: 'crowbar'},
  {category: 'furniture', name: 'dresser'},
  {category: 'tool', name: 'dustpan'},
  {category: 'tool', name: 'stapler'},
  {category: 'toiletries', name: 'lipstick'},
  {category: 'toiletries', name: 'perfume'},
  {category: 'toiletries', name: 'shampoo'},
  {category: 'toiletries', name: 'nailfile'},
  {category: 'toiletries', name: 'sunblock'},
  {category: 'toiletries', name: 'hairdye'},
  {category: 'toiletries', name: 'hairgel'},
  {category: 'toiletries', name: 'mascara'},
  {category: 'computing', name: 'computer'},
  {category: 'computing', name: 'facebook'},
  {category: 'computing', name: 'firewall'},
  {category: 'computing', name: 'keyboard'},
  {category: 'computing', name: 'password'},
  {category: 'computing', name: 'hashtag'},
  {category: 'computing', name: 'macbook'},
  {category: 'computing', name: 'twitter'},
  {category: 'weapon', name: 'catapult'},
  {category: 'weapon', name: 'crossbow'},
  {category: 'weapon', name: 'dynamite'},
  {category: 'weapon', name: 'fireball'},
  {category: 'weapon', name: 'bayonet'},
  {category: 'weapon', name: 'bazooka'},
  {category: 'weapon', name: 'handgun'},
  {category: 'weapon', name: 'missile'},
  ...
  {category: 'weapon', name: 'cannon'},
  {category: 'clothing', name: 'earmuffs'},
  {category: 'accessory', name: 'eyepatch'},
  {category: 'accessory', name: 'headband'},
  {category: 'accessory', name: 'kneepads'},
  {category: 'accessory', name: 'necklace'},
  {category: 'accessory', name: 'nosering'},
  {category: 'clothing', name: 'overalls'},
  {category: 'clothing', name: 'pantsuit'},
  {category: 'accessory', name: 'partyhat'},
  {category: 'clothing', name: 'raincoat'},
  {category: 'accessory', name: 'shoelace'},
  {category: 'clothing', name: 'slippers'},
  {category: 'clothing', name: 'sneakers'},
  {category: 'clothing', name: 'swimsuit'},
  {category: 'accessory', name: 'umbrella'},
  {category: 'accessory', name: 'bandana'},
  {category: 'accessory', name: 'earring'},
  {category: 'accessory', name: 'hairtie'},
  {category: 'accessory', name: 'handbag'},
  {category: 'clothing', name: 'mittens'},
  {category: 'clothing', name: 'pajamas'},
  {category: 'clothing', name: 'sandals'},
  {category: 'clothing', name: 'sweater'},
  {category: 'clothing', name: 'bikini'},
  {category: 'medical', name: 'crutches'},
  {category: 'medical', name: 'dandruff'},
  {category: 'medical', name: 'dentures'},
  {category: 'medical', name: 'firstaid'},
  {category: 'medical', name: 'headache'},
  {category: 'medical', name: 'hospital'},
  {category: 'medical', name: 'insomnia'},
  {category: 'medical', name: 'medicine'},
  {category: 'medical', name: 'papercut'},
  {category: 'medical', name: 'seasick'},
  {category: 'medical', name: 'sunburn'},
  {category: 'medical', name: 'vaccine'},
  {category: 'medical', name: 'vitamin'},
  {category: 'plant', name: 'branches'},
  {category: 'plant', name: 'eggplant'},
  {category: 'geography', name: 'hongkong'},
  {category: 'plant', name: 'palmtree'},
  {category: 'plant', name: 'pinecone'},
  {category: 'plant', name: 'pinetree'},
  {category: 'plant', name: 'primrose'},
  {category: 'geography', name: 'scotland'},
  {category: 'geography', name: 'america'},
  {category: 'geography', name: 'atlanta'},
  {category: 'geography', name: 'bahamas'},
  {category: 'geography', name: 'england'},
  {category: 'geography', name: 'finland'},
  {category: 'geography', name: 'florida'},
  {category: 'geography', name: 'germany'},
  {category: 'geography', name: 'holland'},
  {category: 'geography', name: 'ireland'},
  {category: 'geography', name: 'jamaica'},
  {category: 'geography', name: 'newyork'},
  {category: 'plant', name: 'oaktree'},
  {category: 'geography', name: 'orlando'},
  {category: 'plant', name: 'seaweed'},
  {category: 'plant', name: 'bamboo'},
  {category: 'plant', name: 'carrot'},
  {category: 'plant', name: 'celery'},
  {category: 'plant', name: 'cherry'},
  {category: 'plant', name: 'garlic'},
  {category: 'plant', name: 'grapes'},
  {category: 'anatomy', name: 'backbone'},
  {category: 'location location location', name: 'cemetery'},
  {category: 'anatomy', name: 'forehead'},
  {category: 'anatomy', name: 'mustache'},
  {category: 'anatomy', name: 'nosehair'},
  {category: 'anatomy', name: 'shoulder'},
  {category: 'anatomy', name: 'skeleton'},
  {category: 'anatomy', name: 'tentacle'},
  {category: 'anatomy', name: 'whiskers'},
  {category: 'anatomy', name: 'eyeball'},
  {category: 'anatomy', name: 'eyebrow'},
  {category: 'anatomy', name: 'eyelash'},
  {category: 'anatomy', name: 'kneecap'},
  {category: 'anatomy', name: 'knuckle'},
  {category: 'location location location', name: 'library'},
  {category: 'location location location', name: 'mansion'},
  {category: 'location location location', name: 'petshop'},
  {category: 'anatomy', name: 'stomach'},
  {category: 'location location location', name: 'theater'},
  {category: 'anatomy', name: 'unibrow'},
  {category: 'location location location', name: 'africa'},
  {category: 'location location location', name: 'brazil'},
  {category: 'location location location', name: 'canada'},
  {category: 'location location location', name: 'casino'},
  {category: 'location location location', name: 'castle'},
  {category: 'location location location', name: 'church'},
  {category: 'location location location', name: 'circus'},
  {category: 'location location location', name: 'dallas'},
  {category: 'location location location', name: 'france'},
  {category: 'location location location', name: 'hawaii'},
  {category: 'transportation', name: 'rowboat'},
  {category: 'transportation', name: 'shuttle'},
  {category: 'transportation', name: 'airplane'},
  {category: 'transportation', name: 'forklift'},
  {category: 'transportation', name: 'golfcart'},
  {category: 'transportation', name: 'sailboat'},
  {category: 'transportation', name: 'towtruck'},
  {category: 'transportation', name: 'tricycle'},
  {category: 'transportation', name: 'zeppelin'},
  {category: 'transportation', name: 'bicycle'},
  {category: 'transportation', name: 'dogsled'},
  {category: 'transportation', name: 'minivan'},
  {category: 'transportation', name: 'porsche'},
  {category: 'transportation', name: 'scooter'},
  {category: 'transportation', name: 'tractor'},
  {category: 'transportation', name: 'tugboat'},
  {category: 'music', name: 'bagpipes'},
  {category: 'music', name: 'guitar'},
  {category: 'music', name: 'daftpunk'},
  {category: 'music', name: 'macarena'},
  {category: 'music', name: 'musicbox'},
  {category: 'music', name: 'skrillex'},
  {category: 'music', name: 'trombone'},
  {category: 'music', name: 'beatles'},
  {category: 'music', name: 'beyonce'},
  {category: 'music', name: 'blondie'},
  {category: 'music', name: 'bonjovi'},
  {category: 'music', name: 'drumset'},
  {category: 'music', name: 'dubstep'},
  {category: 'music', name: 'nirvana'},
  {category: 'music', name: 'outkast'},
  {category: 'music', name: 'shakira'},
  {category: 'music', name: 'ukulele'},
  {category: 'mythology', name: 'griffin'},
  {category: 'mythology', name: 'atlantis'},
  {category: 'mythology', name: 'hercules'},
  {category: 'mythology', name: 'minotaur'},
  {category: 'mythology', name: 'poseidon'},
  ...
  {category: 'mythology', name: 'vampire'},
  {category: 'mythology', name: 'dragon'},
  {category: 'famous person', name: 'angelina'},
  {category: 'famous person', name: 'bob dylan'},
  {category: 'famous person', name: 'brad pitt'},
  {category: 'famous person', name: 'bruce lee'},
  {category: 'famous person', name: 'geronimo'},
  {category: 'famous person', name: 'greenday'},
  {category: 'famous person', name: 'katemoss'},
  {category: 'famous person', name: 'ladygaga'},
  {category: 'famous person', name: 'lilwayne'},
  {category: 'famous person', name: 'ludacris'},
  {category: 'famous person', name: 'mchammer'},
  {category: 'famous person', name: 'tomhanks'},
  {category: 'famous person', name: 'beckham'},
  {category: 'famous person', name: 'colbert'},
  {category: 'famous person', name: 'jayleno'},
  {category: 'famous person', name: 'lincoln'},
  {category: 'famous person', name: 'picasso'},
  {category: 'famous person', name: 'rihanna'},
  {category: 'famous person', name: 'vangogh'},
  {category: 'famous person', name: 'justin bieber'},
  {category: 'famous person', name: 'eminem'},
  {category: 'famous person', name: 'gandhi'},
  {category: 'sports', name: 'baseball'},
  {category: 'sports', name: 'dumbbell'},
  {category: 'sports', name: 'football'},
  {category: 'sports', name: 'goalpost'},
  {category: 'sports', name: 'golfclub'},
  {category: 'sports', name: 'halfpipe'},
  {category: 'sports', name: 'handball'},
  {category: 'sports', name: 'iceskate'},
  {category: 'sports', name: 'jumprope'},
  {category: 'sports', name: 'longjump'},
  {category: 'sports', name: 'minigolf'},
  {category: 'sports', name: 'olympics'},
  {category: 'sports', name: 'pingpong'},
  {category: 'sports', name: 'slamdunk'},
  {category: 'sports', name: 'sledding'},
  {category: 'sports', name: 'swimming'},
  {category: 'sports', name: 'archery'},
  {category: 'sports', name: 'bowling'},
  {category: 'sports', name: 'fencing'},
  {category: 'sports', name: 'fishing'},
  {category: 'sports', name: 'homerun'},
  {category: 'sports', name: 'javelin'},
  {category: 'sports', name: 'rebound'},
  {category: 'sports', name: 'referee'},
  {category: 'sports', name: 'boxing'},
  {category: 'pop culture', name: 'haymitch'},
  {category: 'pop culture', name: 'autobots'},
  {category: 'pop culture', name: 'avengers'},
  ...
  {category: 'pop culture', name: 'startrek'},
  {category: 'pop culture', name: 'starwars'},
  {category: 'pop culture', name: 'superman'},
  {category: 'pop culture', name: 'aladdin'},
  {category: 'pop culture', name: 'aquaman'},
  {category: 'pop culture', name: 'asterix'},
  {category: 'pop culture', name: 'hawkeye'},
  {category: 'pop culture', name: 'katniss'},
  {category: 'pop culture', name: 'madonna'},
  {category: 'pop culture', name: 'metroid'},
  {category: 'pop culture', name: 'pikachu'},
  ...
  {category: 'pop culture', name: 'beavis'},
  {category: 'pop culture', name: 'bowser'},
  {category: 'profession', name: 'assassin'},
  {category: 'profession', name: 'director'},
  {category: 'profession', name: 'gangster'},
  {category: 'profession', name: 'gardener'},
  {category: 'profession', name: 'magician'},
  ...
  {category: 'profession', name: 'captain'},
  {category: 'profession', name: 'cashier'},
  {category: 'profession', name: 'cowgirl'},
  {category: 'profession', name: 'dentist'},
  {category: 'profession', name: 'drummer'},
  {category: 'profession', name: 'gymnast'},
  {category: 'profession', name: 'mailman'},
  ...
  {category: 'profession', name: 'painter'},
  {category: 'profession', name: 'plumber'},
  {category: 'profession', name: 'poolboy'},
  {category: 'profession', name: 'sheriff'},
  {category: 'profession', name: 'soldier'},
  {category: 'profession', name: 'surgeon'},
  {category: 'profession', name: 'teacher'},
  ...
  {category: 'food', name: 'burrito'},
  {category: 'food', name: 'coconut'},
  {category: 'food', name: 'cookies'},
  {category: 'food', name: 'corndog'},
  {category: 'food', name: 'cupcake'},
  {category: 'food', name: 'doritos'},
  {category: 'food', name: 'eggroll'},
  {category: 'food', name: 'hambone'},
  {category: 'food', name: 'hamwich'},
  {category: 'food', name: 'ketchup'},
  {category: 'food', name: 'mustard'},
  {category: 'food', name: 'noodles'},
  {category: 'food', name: 'oatmeal'},
  {category: 'food', name: 'pancake'},
  {category: 'food', name: 'peaches'},
  {category: 'food', name: 'popcorn'},
  {category: 'food', name: 'pretzel'},
  {category: 'food', name: 'pumpkin'},
  {category: 'food', name: 'sausage'},
